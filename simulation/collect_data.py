...
def collect_data(watch_data, watch_index, CTRL, ACM, reg_id, reg_iq, reg_speed, fe_htz):
	...
	watch_data[6][watch_index] = CTRL.idq[0]
	watch_data[7][watch_index] = CTRL.idq[1]
	watch_data[8][watch_index] = CTRL.cmd_idq[0]
	...
	watch_data[14][watch_index] = CTRL.omega_syn
	watch_data[15][watch_index] = ACM.Tem
