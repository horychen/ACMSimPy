...
def collect_data(watch_data, watch_index, CTRL, ACM, reg_id, reg_iq, reg_speed, fe_htz):
	...
	watch_data[4][watch_index] = CTRL.idq[0]
	watch_data[5][watch_index] = CTRL.idq[1]
	watch_data[6][watch_index] = CTRL.cmd_idq[0]
	watch_data[7][watch_index] = CTRL.cmd_idq[1]
	...
	watch_data[12][watch_index] = CTRL.uab[0]
	watch_data[13][watch_index] = CTRL.uab[1]
	watch_index += 1
	return watch_index