...
class CustomDataFrame:
    ...
    def plot(self, machine_times, watch_data, Lq_param=1.0, Rs_param=1.0, ELL_param = 0.1):
        ...
        #     plt.title(f'Saturation_Inductance_{Lq_param}-Resistance_{Rs_param}_Speed_{CTRL.cmd_rpm}_Load_{ACM.TLoad}_ell_{ELL_param}')
        #     fig.savefig(f'images/saturation/TimeDomain_Inductance_{Lq_param}-Resistance_{Rs_param}_Speed_{CTRL.cmd_rpm}_Load_{ACM.TLoad}_ell_{ELL_param}.png', dpi=400, bbox_inches='tight', pad_inches=0)
        # elif CTRL.index_voltage_model_flux_estimation == 2:
        #     plt.title(f'Boldea_Inductance_{Lq_param}-Resistance_{Rs_param}_Speed_{CTRL.cmd_rpm}_Load_{ACM.TLoad}')
        #     fig.savefig(f'images/boldea/TimeDomain_Inductance_{Lq_param}-Resistance_{Rs_param}_Speed_{CTRL.cmd_rpm}_Load_{ACM.TLoad}.png', dpi=400, bbox_inches='tight', pad_inches=0)
        # elif CTRL.index_voltage_model_flux_estimation == 3:
        #     # plt.title(f'Saturation_sudden_Inductance_{Lq_param}-Resistance_{Rs_param}_Speed_{CTRL.cmd_rpm}_Load_{ACM.TLoad}_ell_{ELL_param}')
        #     fig.savefig(f'images/saturation_sudden/TimeDomain_Inductance_{Lq_param}-Resistance_{Rs_param}_Speed_{CTRL.cmd_rpm}_Load_{ACM.TLoad}_ell_{ELL_param}.png', dpi=400, bbox_inches='tight', pad_inches=0)
        plt.show()
        # return
        return result
    ...
    def lissajou(self, watch_data_as_dict, period, path, Lq_param=1.0, Rs_param=1.0, ELL_param = 0.1):
        ...
        # if CTRL.index_voltage_model_flux_estimation == 1:
        #     plt.title(f'Saturation_Inductance_{Lq_param}-Resistance_{Rs_param}_Speed_{CTRL.cmd_rpm}_Load_{ACM.TLoad}_ell_{ELL_param}')
        #     fig.savefig(f'images/saturation/Lissajou_Inductance_{Lq_param}-Resistance_{Rs_param}_Speed_{CTRL.cmd_rpm}_Load_{ACM.TLoad}_ell_{ELL_param}.png', dpi=400, bbox_inches='tight', pad_inches=0)
        # elif CTRL.index_voltage_model_flux_estimation == 2:
        #     plt.title(f'Boldea_Inductance_{Lq_param}-Resistance_{Rs_param}_Speed_{CTRL.cmd_rpm}_Load_{ACM.TLoad}')
        #     fig.savefig(f'images/boldea/Lissajou_Inductance_{Lq_param}-Resistance_{Rs_param}_Speed_{CTRL.cmd_rpm}_Load_{ACM.TLoad}.png', dpi=400, bbox_inches='tight', pad_inches=0)
        # elif CTRL.index_voltage_model_flux_estimation == 3:
        #     # plt.title(f'Saturation_sudden_Inductance_{Lq_param}-Resistance_{Rs_param}_Speed_{CTRL.cmd_rpm}_Load_{ACM.TLoad}_ell_{ELL_param}')
        #     fig.savefig(f'images/saturation_sudden/Lissajou_Inductance_{Lq_param}-Resistance_{Rs_param}_Speed_{CTRL.cmd_rpm}_Load_{ACM.TLoad}_ell_{ELL_param}.png', dpi=400, bbox_inches='tight', pad_inches=0)
        
        #plt.show()
        #fig.savefig(f'images/saturation/Lissajou_acmparam_{Lq_param}-peparam_{Rs_param}.png', dpi=400, bbox_inches='tight', pad_inches=0)
        return None
...
for lq_param in Lq_param:
    ...
    for ell_param in ELL_param:
        ...
        for ii in range(d['NUMBER_OF_SLICES']):
            ...
            # custom.lissajou(watch_data_as_dict, d['CL_TS'], os.path.dirname(__file__) + '/user_yzz.txt', Lq_param=lq_param, Rs_param=rs_param, ELL_param = ell_param)
plt.show()
#resistance mismatch

# Lq_param = [1]
# #Rs_param = [1.5, 1.25, 1, 0.75 ,0.5]
# Rs_param = [0.5, 0.75, 1, 1.25, 1.5]
# P2PIndex = 0
# for lq_param in Lq_param:
#     ell_param = 0.07
#     for rs_param in Rs_param:
#         CTRL, ACM, reg_id, reg_iq, reg_speed, reg_dispX, reg_dispY, fe_htz  = InitialAllGlobalClass()
...
# plt.figure()
# plt.plot(Rs_param, e_p2p_saturation, label='Proposed method: $\psi_e$', linestyle = ':', color = '#B8860B', marker = 'o')
# plt.plot(Rs_param, e_p2p_Saturation_sudden, label='Sat. time based: $\psi_e$', linestyle = ':', color = '#808000', marker = 'o')
# plt.legend()
# plt.xlabel(r'Resistance Mismatch [%]', fontsize = 14)#x轴标签
# plt.xticks(Rs_param, Rs_param)
...
# plt.figure()
# plt.plot(Rs_param, e_avg_saturation, label='Proposed method: $\psi_e$', linestyle = ':', color = '#B8860B', marker = 'o')
# plt.plot(Rs_param, e_avg_Saturation_sudden, label='Sat. time based: $\psi_e$', linestyle = ':', color = '#808000', marker = 'o')
# plt.legend()
# plt.xlabel(r'Resistance Mismatch [%]', fontsize = 14)#x轴标签
# plt.xticks(Rs_param, Rs_param)
...
# plt.figure()
# plt.plot(Rs_param, thetaerror_p2p_saturation, label=r'Proposed method: $\sin \theta_e$', linestyle = ':', color = '#B8860B', marker = 'o')
# plt.plot(Rs_param, thetaerror_p2p_Saturation_sudden, label=r'Sat. time based: $\sin  \theta_e$', linestyle = ':', color = '#808000', marker = 'o')
# plt.legend()
# plt.xlabel(r'Resistance Mismatch [%]', fontsize = 14)#x轴标签
# plt.xticks(Rs_param, Rs_param)
...
# plt.figure()
# plt.plot(Rs_param, thetaerror_avg_saturation, label=r'Proposed method: $\sin \theta_e$', linestyle = ':', color = '#B8860B', marker = 'o')
# plt.plot(Rs_param, thetaerror_avg_Saturation_sudden, label=r'Sat. time based: $\sin \theta_e$', linestyle = ':', color = '#808000', marker = 'o')
# plt.legend()
# plt.xlabel(r'Resistance Mismatch [%]', fontsize = 14)#x轴标签
# plt.xticks(Rs_param, Rs_param)
...
#     print(f'thetaeror_avg: {thetaerror_avg_saturation}')
# plt.figure()
# plt.plot(Lq_param, e_p2p_saturation, label='Proposed method: $\psi_e$', linestyle = ':', color = '#B8860B', marker = 'o')
# plt.plot(Lq_param, e_p2p_Saturation_sudden, label='Sat. time based: $\psi_e$', linestyle = ':', color = '#808000', marker = 'o')
# plt.legend()
# plt.xlabel(r'Inductance Mismatch [%]', fontsize = 14)#x轴标签
# plt.xticks(Lq_param, Lq_param)
# plt.ylabel(r'$\psi_{e, \rm p2p}$ [Wb]', fontsize = 14)#y轴标签
...
# plt.figure()
# plt.plot(Lq_param, e_avg_saturation, label='Proposed method: $\psi_e$', linestyle = ':', color = '#B8860B', marker = 'o')
# plt.plot(Lq_param, e_avg_Saturation_sudden, label='Sat. time based: $\psi_e$', linestyle = ':', color = '#808000', marker = 'o')
# plt.legend()
# plt.xlabel(r'Inductance Mismatch [%]', fontsize = 14)#x轴标签
# plt.xticks(Lq_param, Lq_param)
# plt.ylabel(r'$\psi_{e, \rm avg}$ [Wb]', fontsize = 14)#y轴标签
...
# plt.figure()
# plt.plot(Lq_param, thetaerror_p2p_saturation, label=r'Proposed method: $\sin \theta_e$', linestyle = ':', color = '#B8860B', marker = 'o')
# plt.plot(Lq_param, thetaerror_p2p_Saturation_sudden, label=r'Sat. time based: $\sin  \theta_e$', linestyle = ':', color = '#808000', marker = 'o')
# plt.legend()
# plt.xlabel(r'Inductance Mismatch [%]', fontsize = 14)#x轴标签
# plt.xticks(Lq_param, Lq_param)
# plt.ylabel(r'the Peak-to-Peak value of $\sin \theta_e$', fontsize = 14)#y轴标签
...
# plt.figure()
# plt.plot(Lq_param, thetaerror_avg_saturation, label=r'Proposed method: $\sin \theta_e$', linestyle = ':', color = '#B8860B', marker = 'o')
# plt.plot(Lq_param, thetaerror_avg_Saturation_sudden, label=r'Sat. time based: $\sin \theta_e$', linestyle = ':', color = '#808000', marker = 'o')
# plt.legend()
# plt.xlabel(r'Inductance Mismatch [%]', fontsize = 14)#x轴标签
# plt.xticks(Lq_param, Lq_param)
# plt.ylabel(r'$\theta_{e, \rm avg}$', fontsize = 14)#y轴标签
