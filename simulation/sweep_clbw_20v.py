#!/usr/bin/env python
"""Fine-tune CLBW for small_L at 20V bus."""
...
clbws = [100, 150, 200, 250, 300, 350, 400, 500, 600, 800, 1000]

header = f'{"CLBW":>6s} | {"AngSS":>7s} {"AngAll":>7s} {"SpdSS":>7s} {"TrkSS":>7s} {"TrkMax":>7s} {"Dip":>7s} {"Rev":>6s}'
print('DC_BUS_VOLTAGE = 20V')
print(header)
print('-' * 68)
...
for clbw in clbws:
    ...
    try:
        ...
        print(f'{clbw:>6d} | {m["angle_rms_ss_deg"]:>7.2f} {m["angle_rms_all_deg"]:>7.2f} {m["spd_est_rms_ss"]:>7.2f} {m["trk_rms_ss"]:>7.2f} {m["trk_max_ss"]:>7.2f} {m["load_dip_rpm"]:>7.2f} {rev:>6s}')
